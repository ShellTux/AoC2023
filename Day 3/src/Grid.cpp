...
{
	std::cout << "Number: " << number << "; start: " << start.row << ","
	          << start.col << "; end: " << end.row << "," << end.col
	          << std::endl;
}
...
void Number::print(Grid &grid) const
{
	std::cout << "Number: " << number << "; start: " << start.row << ","
	          << start.col << "; end: " << end.row << "," << end.col
	          << "; partNumber: " << isPartNumber(grid) << std::endl;
}

bool Number::operator==(const Number &other) const
{
	return start.row == other.start.row && start.col == other.start.col
	       && end.row == other.end.row && end.col == other.end.col
	       && number == other.number;
}
